...
# ==================== 配置 ====================
# 你的 Streamlit Secrets 中只需设置 API_KEY = "你的真实密钥"
base_url = "https://aigc-api.aitoolcore.com/api/v1"
try:
    api_key = st.secrets["API_KEY"]
except Exception:
    # 本地测试用（请确保这个密钥有效，或换成你自己的）
    api_key = "sk-aigc-6d84addde1f7c03f09f5dac558d0e095be33fd23"

client = OpenAI(base_url=base_url, api_key=api_key)
MODEL_NAME = "qwen3.5-flash"

# 以下所有工具定义和 UI 代码保持不变（你原有的代码无需改动）
# ...（从这里往下全部粘贴你原有的代码）
