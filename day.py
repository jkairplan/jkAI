...
# ==================== 配置 ====================
# 从 Streamlit Secrets 中读取 API 配置（不要硬编码密钥）
# 需要在 Streamlit Cloud 的 Secrets 中设置：
#   OPENAI_BASE_URL = "https://aigc-api.aitoolcore.com/api/v1"
#   OPENAI_API_KEY = "sk-xxxxxxxxxxxxxxxxxxxxxxxx"
# 如果本地测试没有 secrets，可以临时用环境变量或直接填写（但不要提交到 GitHub）

try:
    base_url = st.secrets["OPENAI_BASE_URL"]
    api_key = st.secrets["OPENAI_API_KEY"]
except Exception:
    # 本地运行时，可以在这里直接写测试用的密钥（但注意不要提交到公开仓库）
    base_url = "https://aigc-api.aitoolcore.com/api/v1"
    api_key = "sk-aigc-6d84addde1f7c03f09f5dac558d0e095be33fd23"  # 请替换成你自己的真实密钥
